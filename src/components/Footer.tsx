...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-subtle py-16 mt-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h4 className="text-xl font-semibold mb-5 gradient-text">PM Portfolio</h4>
            <p className="text-medium-grey max-w-xs">
              A product manager passionate about creating user-centric digital experiences that solve real problems.
            </p>
          </div>
          
          <div>
            <h4 className="text-xl font-semibold mb-5">Navigation</h4>
          ...
          <div>
            <h4 className="text-xl font-semibold mb-5">Connect</h4>
            ...
            <div className="mt-5">
              ...
              <a href="mailto:contact@pmportfolio.com" className="text-accent-blue hover:text-accent-purple transition-colors">contact@pmportfolio.com</a>
            </div>
          </div>
        </div>
        
        <div className="border-t border-light-grey mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-medium-grey">© {currentYear} PM Portfolio. All rights reserved.</p>
          <p className="text-sm text-medium-grey mt-3 md:mt-0">
